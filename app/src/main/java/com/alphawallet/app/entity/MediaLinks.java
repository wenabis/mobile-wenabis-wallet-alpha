...
{
    public static final String AWALLET_TELEGRAM_URL = "https://t.me/zoecash";
    ...
    public static final String AWALLET_TWITTER_URL = "https://twitter.com/ZoeCashoficial";
    ...
    public static final String AWALLET_EMAIL2 = "zoe.cash";
    public static final String AWALLET_SUBJECT = "Hi guys. I have beeFn using ZOEWallet";
}
